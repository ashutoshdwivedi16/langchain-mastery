"""
Feature 3: Memory and Conversation - LOCAL VERSION (No API Required)
Uses Ollama for local LLM inference.
Demonstrates RunnableWithMessageHistory for multi-turn conversations.
"""
...
def main():
    ...
    print("\n💡 Feature 3: Memory and Conversation (100% Local, No API needed!)")
