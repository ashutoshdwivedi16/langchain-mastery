"""
Feature 10: Multi-Agent Patterns - LOCAL VERSION
Covers:
  A. Parallel Agents   — multiple agents work independently, results combined
  B. Sequential Agents — output of Agent 1 feeds into Agent 2
  C. Supervisor Pattern — one LLM routes tasks to specialist agents
  D. Agent Handoff     — agents pass control to each other

All using Ollama + LangGraph. No API key needed.
Uses llama3.2 — better at instruction following for multi-agent.
"""
...
def main():
    ...
    print("\n💡 Feature 10: Multi-Agent Patterns (100% Local with Ollama + LangGraph)")
    print("   Using llama3.2 — better at following multi-step instructions.\n")
