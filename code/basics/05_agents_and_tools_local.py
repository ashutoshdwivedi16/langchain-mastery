...
Demonstrates LangGraph ReAct agents with custom tools, multi-step reasoning,
and persistent memory via MemorySaver.
NOTE: Uses llama3.2 — stronger tool and function calling support.
"""
