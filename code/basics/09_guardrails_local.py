"""
Feature 9: Guardrails — Input and Output Validation
Demonstrates custom Python guardrails (length, injection detection, topic filtering,
PII detection) and Pydantic schema validation for structured LLM outputs.
"""
